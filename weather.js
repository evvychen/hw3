let updateWidget = function(data) {
  ...
  jQuery(".card-text").text("The current temp. is " + data.main.temp + " degrees F")
...
let getLocationWeather = function(position) {
  ...
  let locationApiKey = 'f2ff381dbb445b1fac4898def5d10fc4'
...
let getWeather = function(event) {
  ...
  let apiKey = 'f2ff381dbb445b1fac4898def5d10fc4'; // REPLACE THIS VALUE with your own key.
